...
First, I have created a data frame containing a random sample, a
logical, a character, and a factor vector. On the next step, I tried to
calculate the mean of each variable in my data frame.
...
```
    ...
    ## [1] 0.35015697 0.00000000 1.36147126 0.01372430 1.59422274 0.33405410
    ## [7] 0.67128482 0.07655993
...
```
    ...
    ## [1]  0.7003139 -0.8425065  2.7229425  0.0274486  3.1884455  0.6681082
    ## [7]  1.3425696  0.1531199
...
means it has 500 rows and 5columns. The mean of x is 0.0304388, its
median is 0.0354005, and its standard deviation is 0.9512783. The
proportion of cases for which x + y \> 1 is 0.262
